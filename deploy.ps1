...
npm install
(Get-Content node_modules/ngx-electron/lib/electron.service.d.ts).replace('readonly remote: Electron.Remote;','') | Set-Content ../resume-executable/node_modules/ngx-electron/lib/electron.service.d.ts
npm run build
